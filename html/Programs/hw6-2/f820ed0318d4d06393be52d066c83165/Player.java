...
.
        ...
        //都是葫蘆，直接比中間的大小
        if(c1size == 13) this.cards[2].compareTo(that.cards[2]);
        //都是同花，直接比第一個
        else if(c1size == 12) this.cards[0].compareTo(that.cards[0]);
        //都是2ㄆㄟ，比第二個
        else if(c1size == 2) this.cards[1].compareTo(that.cards[1]);
        //都是1ㄆㄟ
        else if (c1size == 1) this.cards[flag1].compareTo(that.cards[flag2]);
        //散牌
        else this.cards[0].compareTo(that.cards[0]);
