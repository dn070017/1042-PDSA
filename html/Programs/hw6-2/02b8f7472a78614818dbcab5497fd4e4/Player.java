...
//        }
    ...
    private int[] recordface(Card[] a){
        ...
        for(int i=0;i<5;i++){
            recording[a[i].faceind()-1]=recording[a[i].faceind()-1]+1;      
        }
        return recording;
    }
    ...
    private int faceind(){
        if (this.equals(""A"")) return 14;
        if (this.equals(""2"")) return 2;
        if (this.equals(""3"")) return 3;
        if (this.equals(""4"")) return 4;
        if (this.equals(""5"")) return 5;
        if (this.equals(""6"")) return 6;
        if (this.equals(""7"")) return 7;
        if (this.equals(""8"")) return 8;
        if (this.equals(""9"")) return 9;
        if (this.equals(""10"")) return 10;
        if (this.equals(""J"")) return 11;
        if (this.equals(""Q"")) return 12;
        if (this.equals(""K"")) return 13;
        return 0;
    }
