...
.
        ...
        for (int j = 0; j <= 14; j++) {
            ...
            if(o[j]==2){count=count+100;mount=j;}
            if(count==10100){count=count*mount;break;}
            if(count<1000){count=count*mount;}
        }
        mount=1;
        for (int j = 0; j <= 14; j++) {//歸零
            o[j] = 0;
        ...
        for (int j = 0; j <= 14; j++) {
            ...
            if(o[j]==2){count1=count1+100;mount=j;}
            if(count1==10100){count1=count1*mount;break;}
            if(count1<1000){count1=count1*mount;}
        }
