...
.
            ...
            Card[] THISS = this.cards;
            Card[] THATT = that.cards;
            for(int i=0;i<THISS.length;i++){
                if(THISS[i].getFace().equals(""A"")){
                    THISS[i]=new Card(""14"",THISS[i].getSuit());
                }else if(THISS[i].getFace().equals(""J"")){
                    THISS[i]=new Card(""11"",THISS[i].getSuit());
                }else if(THISS[i].getFace().equals(""Q"")){
                    THISS[i]=new Card(""12"",THISS[i].getSuit());
                }else if(THISS[i].getFace().equals(""K"")){
                    THISS[i]=new Card(""13"",THISS[i].getSuit());
                }
            }
            for(int i=0;i<THATT.length;i++){
                if(THATT[i].getFace().equals(""A"")){
                    THATT[i]=new Card(""14"",THATT[i].getSuit());
                }else if(THATT[i].getFace().equals(""J"")){
                    THATT[i]=new Card(""11"",THATT[i].getSuit());
                }else if(THATT[i].getFace().equals(""Q"")){
                    THATT[i]=new Card(""12"",THATT[i].getSuit());
                }else if(THATT[i].getFace().equals(""K"")){
                    THATT[i]=new Card(""13"",THATT[i].getSuit());
                }
            }
            ...
            int pID=0;
            for(Card[] cs=THISS;pID<2;cs=THATT){
                ...
                hand[pID]=Integer.parseInt(cs[4].getFace());
            ...
            if(isFlush[0]&&isFlush[1]){
                if(Integer.parseInt(THISS[4].getFace())>Integer.parseInt(THATT[4].getFace())){
                    hand[0]+=5;
                }else if(Integer.parseInt(THISS[4].getFace())<Integer.parseInt(THATT[4].getFace())){
                    hand[1]+=5;
                }
            }
            ...
            if(isStraight[0]&&isStraight[1]){
                if(Integer.parseInt(THISS[4].getFace())==14)hand[0]-=3;
                if(Integer.parseInt(THATT[4].getFace())==14)hand[0]-=3;
                if(Integer.parseInt(THISS[0].getFace())>Integer.parseInt(THATT[0].getFace())){
                    hand[0]+=3;
                }else if(Integer.parseInt(THISS[0].getFace())<Integer.parseInt(THATT[0].getFace())) {
                    hand[1]+=3;
                }
            }
