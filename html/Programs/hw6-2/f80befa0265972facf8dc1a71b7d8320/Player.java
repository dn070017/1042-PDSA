 ...
 public class Player implements Comparable<Player>{ 
    ...
    public double checkhands(Card[] hands){
        ...
        if (check[0][0] == check[1][0] && check[1][0] != check[2][0]){
            if (check[2][0] == check[3][0] && check[3][0] != check[4][0]){
                handpoints = 2*13+check[3][0]+check[3][1] ; //teo pair
            }else if (check[2][0] == check[3][0] && check[3][0] == check[4][0]){
        ...
        }else if (check[1][0] == check[2][0] && check[2][0] != check[3][0]){
            if (check[3][0] == check[4][0]){
                handpoints = 2*13+check[4][0]+check[4][1] ; //two pair
            }else{
                handpoints = 1*13+check[2][0]+check[2][1] ; //one pair
            ...
            handpoints = check[4][0]+check[4][1] ;//highcard
        }
            return handpoints ;
    }
