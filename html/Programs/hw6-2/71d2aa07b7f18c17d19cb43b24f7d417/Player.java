    ...
    public int compareTo(Player that) {
        ...
        if (this_hands_order == that_hands_order) {
            if (this_hands_order == 5) {
                ...
                //int this_full_house_suit = 0;
                //int that_full_house_suit = 0;
                int this_full_house_kicker = 0;
                int that_full_house_kicker = 0;
                ...
                if (this_hands_face_other[0] == this_hands_face_other[1] && this_hands_face_other[1] == this_hands_face_other[2]) {
                    ...
                    //this_full_house_suit = this_hands_suit[2];
                    this_full_house_kicker = this_hands_face_other[3];
                }
                if (this_hands_face_other[2] == this_hands_face_other[3] && this_hands_face_other[3] == this_hands_face_other[4]) {
                    this_full_house = this_hands_face_other[2];
                    //this_full_house_suit = this_hands_suit[2];
                    this_full_house_kicker = this_hands_face_other[0];
                }
                if (that_hands_face_other[0] == that_hands_face_other[1] && that_hands_face_other[1] == that_hands_face_other[2]) {
                    ...
                    //that_full_house_suit = that_hands_suit[2];
                    that_full_house_kicker = that_hands_face_other[3];
                }
                if (that_hands_face_other[2] == that_hands_face_other[3] && that_hands_face_other[3] == that_hands_face_other[4]) {
                    that_full_house = that_hands_face_other[2];
                    //that_full_house_suit = that_hands_suit[2];
                    that_full_house_kicker = that_hands_face_other[0];
                }
                ...
                if (this_full_house == that_full_house) {
                    if (this_full_house_kicker < that_full_house_kicker) {
                        return -1;
                    }
                    if (this_full_house_kicker > that_full_house_kicker) {
                        return 1;
            ...
            if (this_hands_order == 4) {
                ...
                if (this_hands_face_other[4] == that_hands_face_other[4]) {
                    ...
                    if (this_hands_face_other[3] == that_hands_face_other[3]) {
                        if (this_hands_face_other[2] < that_hands_face_other[2]) {
                            return -1;
                        }
                        if (this_hands_face_other[2] > that_hands_face_other[2]) {
                            return 1;
                        ...
                        if (this_hands_face_other[2] == that_hands_face_other[2]) {
                            if (this_hands_face_other[1] < that_hands_face_other[1]) {
                                return -1;
                            }
                            if (this_hands_face_other[1] > that_hands_face_other[1]) {
                                return 1;
                            ...
                            if (this_hands_face_other[1] == that_hands_face_other[1]) {
                                if (this_hands_face_other[0] < that_hands_face_other[0]) {
                                    return -1;
                                }
                                if (this_hands_face_other[0] > that_hands_face_other[0]) {
                                    return 1;
            ...
            if (this_hands_order == 2) {
                ...
                if (this_hands_face_other[3] == that_hands_face_other[3]) {
                    ...
                    if (this_hands_face_other[1] == that_hands_face_other[1]) {
                        int this_kicker = 0; 
                        int that_kicker = 0; 
                        if (this_hands_face_other[0]!=this_hands_face_other[2]) this_kicker = this_hands_face_other[4];
                        if (this_hands_face_other[1]!=this_hands_face_other[3]) this_kicker = this_hands_face_other[0];
                        if (this_hands_face_other[0]!=this_hands_face_other[3]) this_kicker = this_hands_face_other[2];
                        if (that_hands_face_other[0]!=that_hands_face_other[2]) that_kicker = that_hands_face_other[4];
                        if (that_hands_face_other[1]!=that_hands_face_other[3]) that_kicker = that_hands_face_other[0];
                        if (that_hands_face_other[0]!=that_hands_face_other[3]) that_kicker = that_hands_face_other[2];
                        if (this_kicker < that_kicker) {
                            return -1;
                        }
                        if (this_kicker > that_kicker) {
                            return 1;
            ...
            if (this_hands_order == 1) {
                ...
                if (this_one_pair == that_one_pair) {
                    if (this_one_pair_suit < that_one_pair_suit) {
                        return -1;
                    }
                    if (this_one_pair_suit > that_one_pair_suit) {
                        return 1;
