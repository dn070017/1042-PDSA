...
//    	Arrays.sort(that.cards, Card.SUIT_ORDER);
    	...
    	int samecount;
    	if(ufthisface.count()<=3){
    		samecount = 0;
    		for(int i = 0;i<cards.length-2;i++){
    			if(ufthisface.connected(i, i+2)){
    				samecount++;
    			}
    			if(samecount==1){
    				player1typeindex = 5;
    	...
    	if(ufthatface.count()<=3){
    		samecount = 0;
    		for(int i = 0;i<cards.length-2;i++){
    			if(ufthatface.connected(i, i+2)){
    				samecount++;
    			}
    			if(samecount==1){
    				player2typeindex = 5;
    	...
    	if(player1typeindex>player2typeindex){
    		...
    		if(player1typeindex==5 || player1typeindex==2 || player1typeindex==1){
    		...
    		if(player1typeindex==1 || player1typeindex==4){
