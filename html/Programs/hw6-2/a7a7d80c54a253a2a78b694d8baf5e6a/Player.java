...
//    private static final SuitOrder suitOrder = new SuitOrder();
    public static final SuitOrder suitOrder = new SuitOrder();
        ...
        if (result != 0){
            ...
            switch (this.getCardType()) {
                ...
                case one_pair:
                    ...
                    String pair2 = Collections.max(this.cardQuery.getPairs() , faceOrder);
                ...
                case straight:
                    ...
                    String high_card1 = Collections.max(this.cardQuery.getPairs(), faceOrder);
                    String high_card2 = Collections.max(this.cardQuery.getPairs(), faceOrder);
