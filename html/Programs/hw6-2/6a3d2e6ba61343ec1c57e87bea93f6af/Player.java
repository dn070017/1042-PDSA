...
.
    ...
    private int cardsToInt(Card[] cards){
        ...
        for (int i = 0; i < cards.length; i++){
            ++faceCounting[Card.faceToInt(cards[i].getFace())];
            ++suitCounting[Card.suitToInt(cards[i].getSuit())];
        }
        ...
        if (faceCounting[2] == 1 && faceCounting[3] == 1 && faceCounting[4] == 1 && faceCounting[5] == 1 && faceCounting[14] == 1){
            for(int i = 0; i<cards.length; i++){
                if (Card.faceToInt(cards[i].getFace()) == 5){
                    maxCard = cards[i];
                }
            }
            return STRIGHT;
        ...
        if (cardsCount[3] == 1 && cardsCount[2] == 1){
            ...
            for (int i = 0; i < cards.length; i++){
                if (Card.faceToInt(cards[i].getFace()) == fullHouseFace){
            ...
            for (int i = 0; i < cards.length; i++) {
                if (Card.faceToInt(cards[i].getFace()) == pairFace){
