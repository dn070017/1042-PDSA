...
public class Player implements Comparable<Player>{ 
    ...
    for(int j = 0; j < 4; j++) {
        if(this.cards[j].getFace().equals(this.cards[j+1].getFace())) {thispair[j]=1;  }
        if(that.cards[j].getFace().equals(that.cards[j+1].getFace())) {thatpair[j]=1; }        
    } 
    ...
    else  if(Arrays.equals(thisstraight,case11)){ 
        thisvalue=3;   thismax = this.cards[3]; }      
    else  if(Arrays.equals(thispair,case4) ){ 
        thisvalue=2;   thismax = this.cards[3]; }    
    else  if(Arrays.equals(thispair,case5) || Arrays.equals(thispair,case6) ){ 
        thisvalue=2;   thismax = this.cards[4]; } 
    else if (!Arrays.equals(thispair,case7)){
        thisvalue=1;   thismax = this.cards[2];}
    else if (!Arrays.equals(thispair,case8)){
        thisvalue=1;   thismax = this.cards[3];}
    else if (!Arrays.equals(thispair,case9)){
        thisvalue=1;   thismax = this.cards[4];}
    else if (!Arrays.equals(thispair,case10)){
        thisvalue=1;   thismax = this.cards[5];}    
   ...
   else  if(Arrays.equals(thatstraight,case11)){ 
        thatvalue=3;   thatmax = that.cards[3]; }      
    
    else  if(Arrays.equals(thatpair,case4) ){ 
        thatvalue=2;   thatmax = that.cards[3]; }
    else  if(Arrays.equals(thatpair,case5) || Arrays.equals(thatpair,case6) ){ 
        thatvalue=2;   thatmax = that.cards[4]; } 
    else if (!Arrays.equals(thatpair,case7)){
        thatvalue=1;   thatmax = that.cards[2];}
    else if (!Arrays.equals(thatpair,case8)){
        thatvalue=1;   thatmax = that.cards[3];}
    else if (!Arrays.equals(thatpair,case9)){
        thatvalue=1;   thatmax = that.cards[4];}
    else if (!Arrays.equals(thatpair,case10)){
        thatvalue=1;   thatmax = that.cards[5];}   
