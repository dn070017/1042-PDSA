...
//        System.out.println(""\n"");
        ...
        if (iFace1[0] == 1 && iFace1[1] == 5 && iFace1[2] == 4 && iFace1[3] == 3 && iFace1[4] == 2) strThis = 0;
        if (iFace2[0] == 1 && iFace2[1] == 5 && iFace2[2] == 4 && iFace2[3] == 3 && iFace2[4] == 2) strThat = 0;
