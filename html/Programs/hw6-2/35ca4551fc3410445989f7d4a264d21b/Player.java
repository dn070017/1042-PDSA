...
public class Player implements Comparable<Player>{ 
    ...
    public double pairs(){
        ...
        for(int i = 0;i<cards.length;i++)
        {
         //   System.out.println(""suit""+wateroh[i]+""int""+wateroh[i]);
        }
        int coco=0;
...
.
    ...
    public static void main(String[] args) {
     ...
     fuck[0] = new Card(""4"",""Spades"") ;
     fuck[1] = new Card(""Q"",""Hearts"") ;
     fuck[2] = new Card(""Q"",""Diamonds"") ;
     fuck[3] = new Card(""A"",""Spades"") ;
     fuck[4] = new Card(""4"",""Clubs"") ;
     a[0].setCards(fuck);
     fuck1[0] = new Card(""4"",""Spades"") ;
     fuck1[1] = new Card(""Q"",""Hearts"") ;
     fuck1[2] = new Card(""7"",""Spades"") ;
