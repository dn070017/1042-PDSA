...
public class Player implements Comparable<Player> {
    ...
    private int pairsnumber(Card[] cards){
        int number=0;
         if(facetointeger(cards[0].getFace())==facetointeger(cards[1].getFace()) && facetointeger(cards[2].getFace()) != facetointeger(cards[1].getFace())){
             number++;
             side=1;
         ...
         if(facetointeger(cards[0].getFace())==facetointeger(cards[2].getFace()) && facetointeger(cards[2].getFace()) != facetointeger(cards[3].getFace())){
             if(facetointeger(cards[3].getFace()) != facetointeger(cards[4].getFace())){
                 number++;
                 side=2;
             }
         }
         if(facetointeger(cards[0].getFace())==facetointeger(cards[3].getFace())){
             number++;
             side=3;
         }
         
         if(facetointeger(cards[1].getFace())==facetointeger(cards[2].getFace()) && facetointeger(cards[0].getFace()) != facetointeger(cards[1].getFace()) ){
             number++;
             side=2;
             if(facetointeger(cards[2].getFace()) != facetointeger(cards[3].getFace()) && facetointeger(cards[3].getFace())==facetointeger(cards[4].getFace())){
                 number++;
                 side=4;
             }
             if(facetointeger(cards[2].getFace())==facetointeger(cards[3].getFace())) side=3;
             if(facetointeger(cards[2].getFace())==facetointeger(cards[4].getFace())) side=4;
         }
         if(facetointeger(cards[3].getFace())==facetointeger(cards[2].getFace()) && facetointeger(cards[3].getFace()) != facetointeger(cards[4].getFace()) ){
             number++;
             side=3;
             if(facetointeger(cards[2].getFace()) != facetointeger(cards[1].getFace()) && facetointeger(cards[0].getFace())==facetointeger(cards[1].getFace())){
                 number++;
             }
         }
         
             if(facetointeger(cards[4].getFace())==facetointeger(cards[3].getFace()) && facetointeger(cards[3].getFace()) != facetointeger(cards[2].getFace())){
             number++;
             side=4;
             if(facetointeger(cards[2].getFace())==facetointeger(cards[1].getFace())){
                 if( facetointeger(cards[1].getFace()) != facetointeger(cards[0].getFace()) ){
                     number++;
                 }
             }
             if(facetointeger(cards[0].getFace())==facetointeger(cards[1].getFace()) && facetointeger(cards[2].getFace()) != facetointeger(cards[1].getFace())){
         ...
         if(facetointeger(cards[4].getFace())==facetointeger(cards[2].getFace()) && facetointeger(cards[2].getFace()) != facetointeger(cards[1].getFace())){
             if(facetointeger(cards[1].getFace()) != facetointeger(cards[0].getFace())){
                 number++;
                 side=4;
             }
         }
         if(facetointeger(cards[4].getFace())==facetointeger(cards[1].getFace())){
                 number++;
                 side=4;
         }
