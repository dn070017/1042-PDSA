...
.
        ...
        if (c1 < c2) {
            ...
            if (c1 == 6) {
                ...
                if (this.cards[cards.length - 1].getFace().equals(""A"") && that.cards[cards.length - 1].getFace().equals(""A"") && this.cards[cards.length - 2].getFace().equals(""K"") && that.cards[cards.length - 2].getFace().equals(""K"")) {
