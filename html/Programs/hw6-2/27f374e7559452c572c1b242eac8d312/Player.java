...
//        System.out.println(this.cards[0].getSuit());
        ...
        for(int i=0;i<5;i++){
            ...
            if(thiscardvalue==3){System.out.println(thisvalue[0]+""\t""+thisvalue[1]+""\t""+thisvalue[2]+""\t""+thisvalue[3]+""\t""+thisvalue[4]);}
            if(thatcardvalue==3){System.out.println(thatvalue[0]+""\t""+thatvalue[1]+""\t""+thatvalue[2]+""\t""+thatvalue[3]+""\t""+thatvalue[4]);}        
           ...
           if(thiscardvalue>thatcardvalue){return 1;}
                ...
                for(int i=4;i>=0;i--){
                    ...
                    if( thisvalue[4]==thisvalue[3] && thatvalue[4]==thatvalue[3] ){
                        ...
                        if(thisvalue[3]>thatvalue[2]){value= 1;}
                        else if(thisvalue[3]<thatvalue[2]){value= -1;}
