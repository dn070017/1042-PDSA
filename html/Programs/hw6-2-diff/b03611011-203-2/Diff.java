...
.
        ...
        o[j]=0;
                ...
                switch (that.cards[0].getFace()) {//葫蘆算
            case ""A"":
                o[14]++;
                break;
            case ""J"":
            ...
            case ""K"":
                ...
                break;
            default:
                o[Integer.parseInt(that.cards[0].getFace())]++;
        }
        for (int j = 0; j <= 14; j++) {
            if(o[j]==3){count=count+10000;this.name = that.name;return 0;}
            if(o[j]==2)count=count+100;
        }
                switch (this.cards[0].getFace()) {
            case ""A"":
                o[14]++;
                break;
            case ""J"":
