...
public class Player implements Comparable<Player> {
    ...
    private int isstraight(Card[] cards) {
     ...
     private int pairsnumber2(Card[] cards){
        ...
        if(facetointeger(cards[0].getFace())==facetointeger(cards[1].getFace())  ){
            if(facetointeger(cards[2].getFace())==facetointeger(cards[3].getFace()) && facetointeger(cards[2].getFace())!=facetointeger(cards[1].getFace())&& facetointeger(cards[3].getFace())!=facetointeger(cards[4].getFace()) ){
                a=1;
                side = 3;
            }
        ...
        if(facetointeger(cards[2].getFace())==facetointeger(cards[1].getFace()) && facetointeger(cards[4].getFace())==facetointeger(cards[3].getFace()) ){
            if(facetointeger(cards[2].getFace())!=facetointeger(cards[3].getFace()) && facetointeger(cards[1].getFace())!=facetointeger(cards[2].getFace()) ){
                a=1;
                side = 4;
            }
        }
        ...
        if(facetointeger(cards[0].getFace())==facetointeger(cards[1].getFace())  ){
            ...
            if(facetointeger(cards[1].getFace())==facetointeger(cards[4].getFace()) ) side = 4;
    ...
    public int compareTo(Player that) {
        ...
        if (isfullhouse(this.cards) == 1) {
            ...
            rank1 = 4;
        }else if(pairsnumber2(this.cards)==2){
            rank1=3;
            side1=side;
        ...
        if (isfullhouse(that.cards) == 1) {
            ...
            rank2 = 4;
        }else if(pairsnumber2(that.cards)==2){
            rank2=3;
            side2=side;
