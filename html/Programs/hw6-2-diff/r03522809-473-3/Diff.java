...
//            if(thiscardvalue==4){System.out.println(thisvalue[0]+""\t""+thisvalue[1]+""\t""+thisvalue[2]+""\t""+thisvalue[3]+""\t""+thisvalue[4]);}
//            if(thatcardvalue==4){System.out.println(thatvalue[0]+""\t""+thatvalue[1]+""\t""+thatvalue[2]+""\t""+thatvalue[3]+""\t""+thatvalue[4]);}        
