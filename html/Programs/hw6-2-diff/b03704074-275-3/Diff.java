...
.
        ...
        //都是葫蘆，直接比中間的大小
        if(c1size == 13) return this.cards[2].compareTo(that.cards[2]);
        //都是同花，直接比第一個
        else if(c1size == 12) return this.cards[0].compareTo(that.cards[0]);
        //都是2ㄆㄟ，比第二個
        else if(c1size == 2) return this.cards[1].compareTo(that.cards[1]);
        //都是1ㄆㄟ
