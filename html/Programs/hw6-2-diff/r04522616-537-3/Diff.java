...
public class Player implements Comparable<Player>{ 
    ...
    public int compareTo(Player that) {
        ...
        {
            thisCardsType=5;
            thisFullHouse=thisCardNumber[2];
            thisOnePair=0;
        }
        ...
        {
            thatCardsType=5;
            thatFullHouse=thatCardNumber[2];
            thatOnePair=0;
        }
        ...
        else
        {
            ...
            if(thisCardsType==3)
            {
                if(thatCardNumber[0]==2&&thatCardNumber[1]==3&&thatCardNumber[2]==4&&thatCardNumber[3]==5&&thatCardNumber[4]==14 )
                {
                    return 1;
                }
                else if(thisCardNumber[0]==2&&thisCardNumber[1]==3&&thisCardNumber[2]==4&&thisCardNumber[3]==5&&thisCardNumber[4]==14)
