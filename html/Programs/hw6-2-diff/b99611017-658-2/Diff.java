...
public class Player implements Comparable<Player> {
    ...
    private int[] combo(int[] card) {
        ...
        if (faceGroup == 5 && fgMax == 1 && ans[0] == 0) {
            ...
            if (card[0] /4 + 1 == card[1] /4 && card[1] /4 + 1 == card[2] /4 && card[2] /4 + 1 == card[3] /4 && card[3] /4 + 1 == card[4] /4) {
                ans[0] = 3;
                ans[1] = card[card.length - 1];
            }
            if (card[0] /4 + 1 == card[1] /4 && card[1] /4 + 1 == card[2] /4 && card[2] /4 + 1 == card[3] /4 && card[3] /4 + 9 == card[4] /4) {
                ans[0] = 3;
                ans[1] = card[card.length - 1];
            } else {
                ans[0] = 0;
