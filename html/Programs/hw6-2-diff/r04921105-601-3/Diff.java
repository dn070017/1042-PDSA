    ...
    public int compareTo(Player that) {
        ...
        if(cardtorank(this.cards)==cardtorank(that.cards)){
            //2pair:
                ...
                if(cards[0].compareTo(this.cards[0])>cards[0].compareTo(that.cards[0])||cards[3].compareTo(this.cards[3])>cards[3].compareTo(that.cards[3])||cards[0].compareTo(this.cards[0])>cards[3].compareTo(that.cards[3])||cards[3].compareTo(this.cards[3])>cards[0].compareTo(that.cards[0]))
                    return 1;   
                else
                    return -1;
