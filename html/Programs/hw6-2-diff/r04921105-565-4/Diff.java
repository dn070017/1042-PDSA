    ...
    public int compareTo(Player that) {
        ...
        if(cardtorank(this.cards)==cardtorank(that.cards)){
            if(cards[0].getFace().equals(cards[1].getFace())&&cards[3].getFace().equals(cards[4].getFace())){
                if(facetonum(this.cards[0])>facetonum(that.cards[0]))
                    return 1;
                else if (facetonum(this.cards[4])>facetonum(that.cards[4]))
                    return 1;
                else if (facetonum(this.cards[0])<facetonum(that.cards[0]))
                    return -1;
                else if (facetonum(this.cards[4])<facetonum(that.cards[4]))
                    return -1; 
