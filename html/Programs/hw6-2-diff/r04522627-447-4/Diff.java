...
public class Player implements Comparable<Player>{ 
    ...
    public double getPlayerValue(Player p)
    {
        ...
        while(i < 4)
        {
            ...
            {
                c1 = c1 + 2 + getFaceValue(p.cards[i].getFace()) * 0.000001 + getSuitValue(p.cards[i].getSuit()) * 0.0000001;
                if(i == 4) break;
                if(p.cards[i].getFace().equals(p.cards[++i].getFace()))
                {
        ...
        if(c1 < 4.7)
        {
            ...
            {
                c1 = 4.4 + getFaceValue(p.cards[3].getFace()) * 0.001 + getSuitValue(p.cards[3].getSuit()) * 0.0001;
            }
        }
