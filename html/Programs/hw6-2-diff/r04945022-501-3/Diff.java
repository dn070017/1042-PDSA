...
public class Player implements Comparable<Player>{ 
    ...
    public static SuitOrder SUIT_ORDER = new SuitOrder();

    private static FaceOrder FACE_ORDER = new FaceOrder();
    
    private static Type_Order TYPE_ORDER = new Type_Order();
            ...
            switch(this.get_types()){
                ...
                case high:
                    ...
                    if(cons!=0){
                        ...
                        Set<String> strs1 = this.req.Get_SuitSet(hi1);
                        Set<String> strs2 = that.req.Get_SuitSet(hi2);
                        cons = SUIT_ORDER.compare(Collections.max(strs1, SUIT_ORDER), Collections.max(strs2, SUIT_ORDER));
                        return cons;
                    }
                case tpair:
