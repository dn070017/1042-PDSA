...
public class Player implements Comparable<Player> {
    ...
    public int compareTo(Player that) {
        ...
        if (this_hands_order < that_hands_order) return -1;
        if (this_hands_order > that_hands_order) return 1;
        if (this_hands_order == that_hands_order) {
            ...
            if (this_hands_order == 4){
                if (this_hands_suit[4]<that_hands_suit[4]) return -1;
                if (this_hands_suit[4]>that_hands_suit[4]) return 1;
            }
            if (this_hands_order == 3){
                if (this_hands_face_straight[4]<that_hands_face_straight[4]) return -1;
                if (this_hands_face_straight[4]>that_hands_face_straight[4]) return 1;
            }
            if (this_hands_order == 2){
                if (this_hands_face_straight[3]<that_hands_face_straight[3]) return -1;
                if (this_hands_face_straight[3]>that_hands_face_straight[3]) return 1;
            }
