...
//        System.out.println(this.cards[0].getSuit());
        ...
        for(int i=0;i<5;i++){
                ...
                if(that.cards[i].getFace().equals(""A"")){thisvalue[i] = 14;} //get that card value
                else if(that.cards[i].getFace().equals(""J"")){thisvalue[i]= 11;}
                else if(that.cards[i].getFace().equals(""Q"")){thisvalue[i]= 12;}          
                else if(that.cards[i].getFace().equals(""K"")){thisvalue[i]= 13;}
                else{thisvalue[i]=Integer.parseInt(that.cards[i].getFace());}
            }
            ...
            else if( thisvalue[0]==thisvalue[0]-1 &&
                     thisvalue[0]==thisvalue[1]-2 &&
           ...
           if( (thatvalue[4]==thatvalue[3] && thatvalue[4]==thatvalue[2] && thatvalue[1]==thatvalue[0]) ||
               ( thatvalue[0]==thatvalue[1] && thatvalue[0]==thatvalue[2] && thatvalue[3]==thatvalue[4] ) ){thatcardvalue=6;}
                     ...
                     this.cards[0].getSuit().equals(this.cards[2].getSuit()) && 
                     this.cards[0].getSuit().equals(this.cards[3].getSuit()) && 
                     this.cards[0].getSuit().equals(this.cards[4].getSuit())){thatcardvalue=5;}
            ...
            else if( thatvalue[0]==thatvalue[0]-1 &&
                     thatvalue[0]==thatvalue[1]-2 &&
           ...
           if(thiscardvalue>thatcardvalue){return 1;}
                ...
                if((thisvalue[0]==thisvalue[1] && thisvalue[0]==thisvalue[2]) &&
                   (thatvalue[0]==thatvalue[1] && thatvalue[0]==thatvalue[2]) ){if(thisvalue[0]>thatvalue[0]){value= 1;}
                                                                                    ...
                                                                                    if(Card.SUIT_ORDER.compare(this.cards[0],this.cards[0])>0){value= 1;}
                                                                                    else if(Card.SUIT_ORDER.compare(this.cards[0],this.cards[0])<0){value= -1;}
                                                                                    else if(thisvalue[4]>thatvalue[4]){value= 1;}
                                                                                    else if(thisvalue[4]<thatvalue[4]){value= -1;}
                                                                                    else if(thisvalue[4]==thatvalue[4]){
                                                                                      if(Card.SUIT_ORDER.compare(this.cards[4],this.cards[4])>0){value= 1;}
                                                                                      else if(Card.SUIT_ORDER.compare(this.cards[4],this.cards[4])<0){value= -1;}
                                                                                        }
                                                                                    }
                                                                                }
                else if((thisvalue[4]==thisvalue[3] && thisvalue[3]==thisvalue[2]) &&
                        (thatvalue[4]==thatvalue[3] && thatvalue[3]==thatvalue[2]) ){if(thisvalue[4]>thatvalue[4]){value= 1;}
                                                                                else if(thisvalue[4]<thatvalue[4]){value= -1;}
                                                                                else if(thisvalue[4]==thatvalue[4]){
                                                                                    if(Card.SUIT_ORDER.compare(this.cards[4],this.cards[4])>0){value= 1;}
                                                                                    else if(Card.SUIT_ORDER.compare(this.cards[4],this.cards[4])<0){value= -1;}
                ...
                for(int i=4;i>=0;i--){
                    ...
                    if(thisvalue[i]>thatvalue[i]){value= 1;break;}
                        ...
                        if(Card.SUIT_ORDER.compare(this.cards[i],this.cards[i])>0){value= 1;break;}
                        else if(Card.SUIT_ORDER.compare(this.cards[i],this.cards[i])<0){value= -1;break;}
                         }
                    }
           }
                    ...
                    if( thisvalue[4]==thisvalue[3] && thatvalue[4]==thatvalue[3] ){
                        ...
                        if(Card.SUIT_ORDER.compare(this.cards[3],this.cards[3])>0){value= 1;}
                        else if(Card.SUIT_ORDER.compare(this.cards[3],this.cards[3])<0){value= -1;}
                                }
                     else if(thisvalue[4]==thisvalue[3] && thatvalue[3]==thatvalue[2]){value= 1;}
                     else if(thisvalue[3]==thisvalue[2] && thatvalue[4]==thatvalue[3]){value=-1;}
                      }
               ...
               int vi=0,va=0;
                  ...
                  if(vi>va){value= 1;}
                        ...
                        if(Card.SUIT_ORDER.compare(this.cards[vi],this.cards[va])>0){value= 1;}
                        else if(Card.SUIT_ORDER.compare(this.cards[vi],this.cards[va])<0){value= -1;}
                  }
           }
