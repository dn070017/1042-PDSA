...
public class FindNeighbors {
    ...
    public Node fristroot = null;
    private MaxPQ<setPoint> Maxfindnearpoints = null ;
    private Node another =null ;
...
//                                System.out.println('d');
    ...
    public void putInPQ(Node current,Point2D point,int k){
        ...
        if( current.getPass()==1 )return;
                    current.setPass(1);
                            if( Maxfindnearpoints.size()<k){
                                Maxfindnearpoints.insert(new setPoint(point,current.getPoint())); }
                            else if(Maxfindnearpoints.max().dis> current.getPoint().distanceTo(point) ){
...
//        Maxfindnearpoints=null;
        System.out.println(Maxfindnearpoints.isEmpty());
        return result;
    }
 ...
 private static class setPoint implements Comparable <setPoint> { 
     ...
     public setPoint(Point2D targert,Point2D points) { 
            ...
            this.points = points;
            this.dis=this.targert.distanceTo(this.points);
        }
    ...
    public static void main(String[] args)throws Exception {
     try (BufferedReader br = new BufferedReader(new FileReader(args[0]))) {
          ...
          Point2D mytarget = new Point2D(0.531440,0.616918 );
          int ansnuber =10;
          do{
