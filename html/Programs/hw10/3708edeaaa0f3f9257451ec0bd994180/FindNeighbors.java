...
public class FindNeighbors {
    ...
    public MinPQ<setPoint> findnearpoints =new MinPQ<setPoint>() ;
    public Node current ;
    public Node another ;
     ...
     while( !(otherside.right==null) || !(otherside.left==null) ){
        if(otherside.direct==true){
                if( point.x()>otherside.point.x() ){
                    ...
                    findnearpoints.insert(dis2target);
...
//            System.out.println( current.number+1 +"" ""+current.point+"" ""+current.direct);
            if( current.direct == true ){
                if( point.x()>current.point.x() ){
                    ...
                    findnearpoints.insert(dis2target);
//                    System.out.println( current.number+1 +"" ""+current.point);
...
//                    System.out.println(current.uplevel.point.x());
//                    System.out.println(current.point.y());
//                    System.out.println(current.uplevel.point.x());
...
//        System.out.println( current.number+1 +"" ""+current.point);
    ...
    public Point2D[] query(Point2D point, int k){
        ...
        System.out.println("" "");
        for(int i=0;i<k;i++){
//            System.out.println(findnearpoints.min().points);
            result[i]=findnearpoints.delMin().points;
        }
