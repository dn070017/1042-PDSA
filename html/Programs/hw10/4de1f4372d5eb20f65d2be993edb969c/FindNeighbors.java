    ...
    public Point2D[] query(Point2D point, int k){
        ...
        while(!searchpath.isEmpty()){
            ...
            if(pq.size() < k){
                ...
                if(relation.get(tempd)==null){
                    //System.out.println(x.getLevel()+"" ""+x.getValue().x()+"" ""+x.getValue().y());
                    pq.insert(tempd);
                    relation.put(tempd, x.getValue());
                }
            }
            else{//System.out.println(""HI  "");
                if(tempd < pq.max() && relation.get(tempd)==null){//System.out.println(""HI  ""+x.getLevel()+"" ""+x.getValue().x()+"" ""+x.getValue().y());
                            pq.delMax();
                            pq.insert(tempd);
                            relation.put(tempd, x.getValue());}//FUCK
                if(x.getLevel()%2==0){
