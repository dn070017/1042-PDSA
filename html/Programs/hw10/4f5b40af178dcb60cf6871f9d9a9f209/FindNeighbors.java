...
//                    System.out.println(otherside.number+1 +"" ""+otherside.point);
                ...
                if( Math.abs(point.x()-otherside.uplevel.point.x()) <  Math.abs(point.y()-otherside.point.y()) ){ // Find another side
...
//                    System.out.println(Math.abs(point.y()-otherside.uplevel.point.y()) <  Math.abs(point.x()-otherside.point.x()));
                if( Math.abs(point.y()-otherside.uplevel.point.y()) <  Math.abs(point.x()-otherside.point.x()) ){  // Find another side
...
//                    System.out.println(otherside.number+1 +"" ""+otherside.point);
                    if( Maxfindnearpoints.size()<=k && Maxfindnearpoints.max().dis>current.point.distanceSquaredTo(point)){
                        Maxfindnearpoints.delMax();
                        setPoint dis2target=new setPoint(point,otherside.point);
                        Maxfindnearpoints.insert(dis2target);}
...
//                 System.out.println(current.uplevel.point);
//                 System.out.println(point);
//                System.out.println(Math.abs(point.x()-current.uplevel.point.x()) <  Math.abs(point.y()-current.point.y()));
                if( Math.abs(point.x()-current.uplevel.point.x()) <  Math.abs(point.y()-current.point.y()) ){ // Find another side
...
//                System.out.println( Math.abs(point.y()-current.uplevel.point.y()) <  Math.abs(point.x()-current.point.x()));
                if( Math.abs(point.y()-current.uplevel.point.y()) <  Math.abs(point.x()-current.point.x()) ){ // Find another side
 ...
 private static class setPoint implements Comparable <setPoint> { 
    ...
    public static void main(String[] args)throws Exception {
     ...
     try (BufferedReader br = new BufferedReader(new FileReader(args[0]))) {
          ...
          Point2D mytarget = new Point2D(0.45,0.2);
          int ansnuber =3;
          do{
