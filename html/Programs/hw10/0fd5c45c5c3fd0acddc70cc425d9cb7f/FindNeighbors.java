...
public class FindNeighbors {
  ...
  private void printPreOrderRec( MaxPQ maxpq,Node tree2 ,Point2D point ,int k) {
     ...
     if(mode==0){  
      ...
      printPreOrderRec( maxpq,tree2.getLeft(),point,k);
      printPreOrderRec( maxpq,tree2.getRight(),point,k);
      if(mode==1){mode=0;} 
  ...
  //      System.out.println(result[j]);
    ...
    //          System.out.println(point[num]);
     ...
     /*    for(int i=0;i<num;i++){   
        ...
        Point2D[] temp= tree.query( a , 10);
        a=new Point2D(0.144932 ,0.938569);
       // temp= tree.query( a,3);
        a=new Point2D(0.144932 ,0.938569);
       temp= tree.query(a,10);
       for(int i=0;i<10;i++)
