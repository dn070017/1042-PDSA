...
int A=0;
    public Point2D[] query(Point2D point, int k) {
        ...
        Stack<Node> rebuid = new Stack<Node>();
        stack.push(root);
        //rebuid.push(root);
        Node node=root;
       // stack.push(root);
...
//       ArrayList<Node> arr = preorder(root);
// for(int i=0;i<size;i++){
////     System.out.println(rebuid.pop().p);
//     System.out.println(""A"");
//     System.out.println(arr.get(i).L);
//     System.out.println(arr.get(i).R);
//     System.out.println(arr.get(i).p);
// }
       // rebuid = stack;
     //System.out.println(stack.peek().p);
     //System.out.println(stack.peek()!=null||stack.peek()!=null);
        while(stack.size()>0){
            Node se=stack.pop();
           // rebuid.push(se);
            //底部的點
           ...
           //System.out.println(node.p); 
            ...
            if(se.vertical==true){                
                    if(point.x()<se.p.x()){
                        if(pq.min().distance>Math.abs(point.x()-se.p.x()) || pq.size()<k){
                        if(se.right!=null){                            
                            se=se.right;
                            stack.push(se);
                    ...
                    if(point.y()<se.p.y()){
                        ...
                        if(pq.min().distance>Math.abs(point.y()-se.p.y()) || pq.size()<k){
...
//            }
 ...
 while (!rebuid.isEmpty()){
     Node reb = rebuid.pop();
     reb.R=0;
     reb.L=0;
     //System.out.println(reb.p);
 }
// ArrayList<Node> arrl = preorder(root);
// for(int i=0;i<size;i++){
//     System.out.println(i);
//     System.out.println(arrl.get(i).p);
//     System.out.println(arrl.get(i).R);
//     System.out.println(arrl.get(i).L);
//  
// }         
...
//           System.out.println();
//
//        p= new Point2D(0.3833339428,0.1459115606);
//           Num=20;
