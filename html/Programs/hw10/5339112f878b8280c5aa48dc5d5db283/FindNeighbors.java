...
public class FindNeighbors {
    ...
    public static BST<Double, Point2D> save = new BST<Double, Point2D>();
    public static BST<Integer, Point2D> temp = new BST<Integer, Point2D>();
    public static FindNeighbors kdtree = new FindNeighbors();
    public static ArrayList<Point2D> Pointtemp = new ArrayList<Point2D>();
...
//            public void query(Point2D point, int k) {
        ...
        result[i]=last;
        Pointtemp.remove(last);
        kdtree.inittree();
//        Point2D last2 = kdtree.nearest(point);
...
//       System.out.println(Pointtemp.get(0));
//       System.out.printf(""\n%d"",Pointtemp.size());
...
//        }
    ...
    public static void main(String[] args) throws Exception {
        try (BufferedReader br = new BufferedReader(new FileReader(args[0]))) {
            //Point2D[] test = new Point2D[1000];
            for (int i = 0; i < 1000; i++) {
                String[] data = br.readLine().split("" "");
                //test[i] = new Point2D(Double.parseDouble(data[0]), Double.parseDouble(data[1]));
            ...
            //kdtree.query(new Point2D(0.0354339200, 0.0019446863), 3);
