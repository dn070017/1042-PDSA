...
public class FindNeighbors {
    ...
    //private final RectHV UNIT_SQUARE = new RectHV(0.0, 0.0, 1.0, 1.0);
    ...
    public Point2D nearest(Point2D p, int k) {
        return doNearest(root, p, root.p, k);
    }
...
//                nearestPointCandidate = doNearest(node.left, leftNodeRect, queryPoint, nearestPointCandidate, k);
//                nearestPointCandidate = doNearest(node.right, rightNodeRect, queryPoint, nearestPointCandidate, k);
//            } else {
