...
public class FindNeighbors {
  ...
  private void printPreOrderRec(Node currRoot ,Point2D point ) {
     if (currRoot == null) {
    return ;
     }
     double dis=currRoot.getdistance(point);
     minpq.insert((currRoot));
       //int i=0;
        //a[count]=currRoot.getValue();
       
      //System.out.print(a[i]);
       //count=count+1;
      printPreOrderRec(currRoot.getLeft(),point);
      printPreOrderRec(currRoot.getRight(),point);
  ...
  //      System.out.println(result[j]);
    ...
    //          System.out.println(point[num]);
        ...
        Point2D[] temp= tree.query( a , 3);
         ...
         temp= tree.query( a , 3);
           a=new Point2D(0.531440,0.616918);
