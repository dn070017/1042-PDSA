...
public class FindNeighbors {
    ...
    private void findNearest(Node x, Point2D p, int k, MaxPQ<Event> pq) {
        ...
        double distance_left = 5;
        double distance_right = 5;
    ...
    public static void main(String[] args) throws Exception {
        try (BufferedReader br = new BufferedReader(new FileReader(args[0]))){
            ...
            test2.init(test);
            Point2D point = new Point2D(0.0788253813516349,0.830325729912147);
            Point2D[] result = test2.query(test[20], 10);
            for(int j = 0; j < 10; j++){
