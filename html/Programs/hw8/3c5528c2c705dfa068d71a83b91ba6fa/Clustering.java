...
//            points = new ArrayList<>(Collections.nCopies(N, new Point2D(0,0)));
        ...
        int[] weight = {0,0,0};//FIXME
        weight[0] = 1000*((o0.getSize()-o1.getSize())+o0.getSize()-o2.getSize());// + 100*((o0.calCtd().x())+());
        weight[1] = 1000*((o1.getSize()-o0.getSize())+o1.getSize()-o2.getSize());
        weight[2] = 1000*((o2.getSize()-o0.getSize())+o2.getSize()-o1.getSize());
        ...
        Pair tempPair;
        for(int i0 = 0; i0<o0.getSize()-1; i0++){
            for(int i1 = 0; i1<o0.getSize()-1; i1++) {
                tempPair=new Pair(new Cluster(o0.cps.get(i0)),new Cluster(o1.cps.get(i1)));
                pairsPQ2.insert(tempPair);
            }
        }
        for(int i1 = 0; i1<o0.getSize()-1; i1++){
            for(int i2 = 0; i2<o0.getSize()-1; i2++) {
