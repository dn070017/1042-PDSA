        ...
        try (BufferedReader br = new BufferedReader(new FileReader(args[0]))) {
            ...
            while(flag == 0){
                ...
                if(!yuru.connected(close.a.getIndex(), close.b.getIndex()))  flag=1;
                 ...
                 /* 
            Cluster b;
            MaxPQ<Cluster> mpq = new MaxPQ<Cluster>(number*number);
            for (int i = 0; i < id; i++) {
                if (wei[i].valid == 1) {
                    mpq.insert(wei[i]);
                }
            ...
            for (int i = 0; i < 3; i++) {
                String s1 = String.format(""%.2f"",close.getDistance()) ;
                String s2 = String.format(""%.2f"",close.getDistance()) ;
                System.out.println(String.format(""%.2f"",close.getDistance())  + "" "" + s1 + "" "" + s2);
            }
