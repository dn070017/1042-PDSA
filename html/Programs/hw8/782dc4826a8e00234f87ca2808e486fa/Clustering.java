...
//            }
            ...
            if (N == 1) {
                System.out.printf(""1"" + String.format(""%.2f"", points[0].x()) + "" "" + String.format(""%.2f"", points[0].x()) + ""\n"");
            //System.out.printf(""1"" + String.format(""%.2f"", points[1].x()) + "" "" + String.format(""%.2f"", points[1].x()) + ""\n"");
