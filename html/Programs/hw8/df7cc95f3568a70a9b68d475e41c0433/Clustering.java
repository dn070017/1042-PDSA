        ...
        try(BufferedReader br = new BufferedReader(new FileReader(args[0]))){
            ...
            else if(N==2)
            {
                ...
                else if(point[0].x()>point[1].x())
                {
                    ...
                    StdOut.print(""1""+"" ""+ String.format(""%.2f"", point[0].x())+"" ""+ String.format(""%.2f"", point[0].y())+"" ""+String.format(""%.2f"", distance[0]));
                }
                else
                {
            ...
            else if(N==3)
            {
                ...
                if(point[0].x()>point[1].x()&&point[0].x()>point[2].x())
                {
                    if(point[1].x()>point[2].x())
                    {
                        StdOut.print(""1""+"" ""+ String.format(""%.2f"", point[2].x())+"" ""+ String.format(""%.2f"", point[2].y())+"" ""+""\n"");
                        StdOut.print(""1""+"" ""+ String.format(""%.2f"", point[1].x())+"" ""+ String.format(""%.2f"", point[1].y())+"" ""+""\n"");
                        StdOut.print(""1""+"" ""+ String.format(""%.2f"", point[0].x())+"" ""+ String.format(""%.2f"", point[0].y())+"" ""+String.format(""%.2f"", maxPQ.max()));
                    }
                ...
                else if(point[1].x()>point[0].x()&&point[1].x()>point[2].x())
                {
                    if(point[0].x()>point[2].x())
                    {
                        StdOut.print(""1""+"" ""+ String.format(""%.2f"", point[2].x())+"" ""+ String.format(""%.2f"", point[2].y())+"" ""+""\n"");
                        StdOut.print(""1""+"" ""+ String.format(""%.2f"", point[0].x())+"" ""+ String.format(""%.2f"", point[0].y())+"" ""+""\n"");
                        StdOut.print(""1""+"" ""+ String.format(""%.2f"", point[1].x())+"" ""+ String.format(""%.2f"", point[1].y())+"" ""+String.format(""%.2f"", maxPQ.max()));
                    }
                ...
                else if(point[2].x()>point[1].x()&&point[2].x()>point[0].x())
                {
