...
//            System.out.println(points[15].distanceTo(points[5]));
//            System.out.println(points[18].distanceTo(points[17]));
//            System.out.println(points[15].distanceTo(points[17]));
//            System.out.println(points[18].distanceTo(points[15]));
//            
            int mem1, mem2;
            double inx, iny;
            int b=0;
//          初始化pq
            ...
            double a=1;
                ...
                mem2 = b;
                array[j * 2 + 1] = mem2;
//            inx = (points[mem1].x() + points[mem2].x()) / 2;
//            iny = (points[mem1].y() + points[mem2].y()) / 2;
