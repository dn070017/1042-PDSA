    ...
    public static void main(String[] args) throws Exception {
        try (BufferedReader br = new BufferedReader(new FileReader(args[0]))) {
            ...
            if (Num < 3){
                ...
                double arrr = points[0].distanceTo(points[1]);
                System.out.println(String.format(""%.2f"", arrr));
            }
...
// keep here=============================================
            ...
            int kkk = (int)Math.floor(ch*0.5);
           for (int i = Num+kkk; i<Num+ch; i ++){
                int ra = uf.find(i);
                if (ra ==root_record[0]){
            ...
            System.out.println(Integer.toString(root_size[2]) + "" "" + String.format(""%.2f"", points_ans[2].x()) + "" "" + String.format(""%.2f"", points_ans[2].y()));
                ...
                for (int j = i + 1; j < Num; j++) {
                    ...
                    if(pq.size()>1){
                        ...
                        System.out.println(String.format(""%.2f"", pq.delMax().distance));  
