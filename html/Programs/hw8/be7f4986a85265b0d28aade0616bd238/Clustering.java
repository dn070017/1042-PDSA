...
//            StdDraw.setPenColor(Color.red);
            ...
            orip = new Point2D[NUM * 2 - 3];          // first NUM 是input ,NUM 後為new
            int[] exist = new int[NUM * 2 - 3];          // 0是存在，1是不存在
            int[] size = new int[NUM * 2 - 3];           // cluster的點數
            int num = NUM;
            int countpoint = 0;
...
//                StdDraw.filledCircle(orip[countpoint].x(), orip[countpoint].y(), size[countpoint] / 100);
                ...
                System.out.println(1 + "" "" + orip[0].x() + "" "" + orip[0].y());
                System.out.println(1 + "" "" + orip[1].x() + "" "" + orip[1].y());
                System.out.println(orip[0].distanceTo(orip[1]));
            }
            else{
                System.out.println(1 + "" "" + orip[0].x() + "" "" + orip[0].y());
                System.out.print(0);
