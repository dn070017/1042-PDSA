    ...
    public static void main(String[] args) throws Exception {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(args[0]))) {
            ...
            if (myList.get(0).length > myList.get(1).length && myList.get(1).length > myList.get(2).length) {
                ...
                System.out.print(clustermean(myList.get(0)).x());
                System.out.print("" "");
                System.out.print(clustermean(myList.get(0)).y());
                System.out.printf(""%n"");
                System.out.print(myList.get(1).length+"" "");
                System.out.print(clustermean(myList.get(1)).x());
                System.out.print("" "");
                System.out.print(clustermean(myList.get(1)).y());
                System.out.printf(""%n"");
