...
//                                                            System.out.println("" cluster.get(pair[i].getNodeY()).getNumber() "" + cluster.get(cluster.indexOf(cluster.get(pair[i].getNodeY()))).getMember());
...
//               System.out.println(""cluster num :\"""" + output_group[i].getIndex() + ""\""  cluster size :"" + output_group[i].getSize());

//               ArrayList num_temp = new ArrayList();
//               num_temp = output_group[i].getMember();
//               for (int k = 0; k < output_group[i].getSize(); k++) {
//                    System.out.print(""  num_temp: "" + k + "" is "" + num_temp.get(k));
//               }
//               System.out.println("""");
...
//               System.out.println(output_distance);
//          }
...
//          System.out.println(""X ""+out.getNodeX()+""  Y  ""+out.getNodeY()+""  dis: ""+out.getDistance());
//          System.out.println(Clustering.distance(point_array[out.getNodeX()], point_array[out.getNodeY()]));
//          for (int con = 0; con < N; con++) {
//               System.out.println(""  \"""" + con + ""\"":"" + uf.find(con) + ""  "");
//          }
//
//          System.out.println("""");
