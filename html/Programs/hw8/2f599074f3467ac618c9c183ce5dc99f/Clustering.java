    ...
    private static class Cluster implements Comparable<Cluster>{
        ...
        public int compareTo(Cluster that){
            if(this.size > that.size)
                ...
                if(this.center.x() > that.center.x())
                    return -1;
                else if(this.center.x() == that.center.x()){
                    if(this.center.y() >= that.center.y())
                        return -1;
                    else
                        return 1;
                }
...
//                 System.out.print(pq.size()+""\n"");
                ...
                if(index1 == 0){
                    ptdel[index1++] = new Point2D(Del.c1.center.x(),Del.c1.center.y());
                    ptdel[index1++] = new Point2D(Del.c2.center.x(),Del.c2.center.y());
                    check = 1;
                }
                
//                for(int i=0; i<index1; i++)
//                    System.out.print(ptdel[i]+""\n"");
//                System.out.print(""\n"");
...
//                     System.out.print(check1+""\n"");
                    ...
                    boolean f1 = false;
                    for(int i=0; i<index1;i++){                          
                        f1 = (Del.c1.center.equals(ptdel[i]))||(Del.c2.center.equals(ptdel[i]));
                        if(f1){
                            check1 = 0;
//                            System.out.print(f1+""\n"");
                            break;
...
//                System.out.print(""\n"");
                 ...
                 C1.InClus(Del.c1);
                 C1.InClus(Del.c2);
//                 System.out.print(Del.c1.center+""\n"");
//                 System.out.print(Del.c2.center+""\n"");
//                 System.out.print(C1.center+""\n"");
                 int idx1 = 0;
...
//                    if(flag3)
//                        System.out.print(Cluts[i].center+""\n"");
                    if(!flag3){
//                        if(idx1 < CL1.length){
