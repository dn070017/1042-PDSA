...
//        ArrayList<Clustering> newPoints = new ArrayList<>();
    ...
    public static void main(String[] args) throws Exception {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(args[0]))) {
            ...
            if (clus.size() == 3) {
                String s1 = String.format(""%d %.2f %.2f"", clusterings[2].points.size(), clusterings[2].getX(), clusterings[2].getY());
                System.out.println(s1);
                String s2 = String.format(""%d %.2f %.2f"", clusterings[1].points.size(), clusterings[1].getX(), clusterings[1].getY());
            ...
            String s3 = String.format(""%d %.2f %.2f"", clusterings[0].points.size(), clusterings[0].getX(), clusterings[0].getY());
