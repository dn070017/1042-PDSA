...
public class Clustering{
    ...
    public static void main(String[] args) throws Exception{
        ...
        System.out.printf(""%d %.2f %.2f\n"",cluster.get(0).size+1/2,cluster.get(0).cx,cluster.get(0).cy);
        System.out.printf(""%d %.2f %.2f\n"",cluster.get(1).size+1/2,cluster.get(1).cx,cluster.get(1).cy);
        System.out.printf(""%d %.2f %.2f\n"",cluster.get(2).size+1/2,cluster.get(2).cx,cluster.get(2).cy);
