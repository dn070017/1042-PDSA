    ...
    public static void main(String[] args) throws Exception {
        try (BufferedReader br = new BufferedReader(new FileReader(args[0]))) {
            ...
            if (N < 3 && N > 0) {
                System.out.print(1);
                System.out.print("" "");
                System.out.print(String.format(""%.2f"", gg[0].x));
                System.out.print("" "");
                System.out.print(String.format(""%.2f\n"", gg[0].y));
                System.out.print(1);
                System.out.print("" "");
                System.out.print(String.format(""%.2f"", gg[1].x));
                System.out.print("" "");
                System.out.print(String.format(""%.2f\n"", gg[1].y));
                System.out.print(String.format(""%.2f"", gg[0].distanceTo(gg[1])));
                return;
            }
            if (N == 0) {
