    ...
    public static void main(String[] args) {
      ...
      for (int i = 0; i < N; i++) {
        ...
        for (int i = sup_clu.length-1; i >=0 ; i--) {
           double x =sup_clu[i].pp[0].x() ;
           double y =sup_clu[i].pp[0].y() ;
          // System.out.printf(""%.2f"", x);
           System.out.println(sup_clu[i].fat+"" ""+Math.rint(x*100)/100+"" ""+Math.rint(y*100)/100);

         //  System.out.println();
           // System.out.println(sup_clu[i].pp[0] + ""    "" + sup_clu[i].fat);
        }
        for (int i = 0; i < N - 1; i++) {
            for (int j = i + 1; j < N; j++) {
              //  System.out.println(uf.find(i));
        ...
        //int i = Integer.valueOf((String) distence.delMin());
        double i = (double) distence.delMin();
        System.out.println(Math.rint(i*100)/100);
        
        //System.out.println(distence.delMin());
    }
}
