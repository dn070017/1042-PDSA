        ...
        try (BufferedReader br = new BufferedReader(new FileReader(args[0]))) {
            ...
            if (myList.size() <= 3) {
                ...
                if (myList.get(0).length > myList.get(1).length && myList.get(1).length > myList.get(2).length) {
                    ...
                    System.out.printf(""%n"");
                } else if (myList.get(0).length > myList.get(2).length && myList.get(2).length > myList.get(1).length) {
                    System.out.print(myList.get(0).length + "" "");
                    System.out.printf(""%.2f"", clustermean(myList.get(0)).x());
                    System.out.print("" "");
                    System.out.printf(""%.2f"", clustermean(myList.get(0)).y());
                    ...
                    System.out.printf(""%.2f"", clustermean(myList.get(1)).y());
                    System.out.printf(""%n"");
                } else if (myList.get(1).length > myList.get(0).length && myList.get(0).length > myList.get(2).length) {
                    System.out.print(myList.get(1).length + "" "");
                    System.out.printf(""%.2f"", clustermean(myList.get(1)).x());
                    System.out.print("" "");
                    System.out.printf(""%.2f"", clustermean(myList.get(1)).y());
                    ...
                    System.out.printf(""%.2f"", clustermean(myList.get(2)).y());
                    System.out.printf(""%n"");
                } else if (myList.get(1).length > myList.get(2).length && myList.get(2).length > myList.get(0).length) {
                    System.out.print(myList.get(1).length + "" "");
                    System.out.printf(""%.2f"", clustermean(myList.get(1)).x());
                    System.out.print("" "");
                    System.out.printf(""%.2f"", clustermean(myList.get(1)).y());
                    ...
                    System.out.printf(""%.2f"", clustermean(myList.get(0)).y());
                    System.out.printf(""%n"");
                } else if (myList.get(2).length > myList.get(0).length && myList.get(0).length > myList.get(1).length) {
                    System.out.print(myList.get(2).length + "" "");
                    System.out.printf(""%.2f"", clustermean(myList.get(2)).x());
                    System.out.print("" "");
                    System.out.printf(""%.2f"", clustermean(myList.get(2)).y());
                    ...
                    System.out.printf(""%.2f"", clustermean(myList.get(1)).y());
                    System.out.printf(""%n"");
                } else if (myList.get(2).length > myList.get(1).length && myList.get(1).length > myList.get(0).length) {
                    System.out.print(myList.get(2).length + "" "");
                    System.out.printf(""%.2f"", clustermean(myList.get(2)).x());
                    System.out.print("" "");
                    System.out.printf(""%.2f"", clustermean(myList.get(2)).y());
                ...
                for (int i = 0; i < myList.get(1).length; i++) {
                    for (int j = 0; j < myList.get(2).length; j++) {
                        Point2D[] pp = new Point2D[2];
                        pp[0] = myList.get(1)[i];
                        pp[1] = myList.get(2)[j];
                        Clustering c = new Clustering(pp);
