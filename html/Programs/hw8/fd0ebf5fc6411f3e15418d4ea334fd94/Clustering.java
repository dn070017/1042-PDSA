     ...
     public void merge(Cluster a)
       {
          ...
          UFpoints.union(this.index, a.index);
          ...
          UFpoints.union(this.index, newCluster.index);
 ...
 public static boolean isValid (Pair a)
   {
    ...
    public static void main(String[] args) throws Exception
    {
       ...
       double xData = 0;
       double yData = 0;
       UFpoints= new QuickUnionUF(2*size-3);
       ...
       int countTimes = size;
        ...
        for(int i=0; i<size-1;i++)       
        {
            ...
            {
               if(!UFpoints.connected(i,j))
               {
                   double temp = array[i].distanceTo(array[j]);
                   if(temp<distance)
                       distance = temp;
               }
//            
