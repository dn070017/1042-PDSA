...
//                                                            ArrayList temp = cluster.get(cluster.indexOf(cluster.get(pair[i].getNodeY()))).getMember();
//                                                            for (int k = 0; k < temp.size(); k++) {
//                                                                      cluster_array[Integer.parseInt(temp.get(k).toString())] = cluster.get(cluster.indexOf(cluster.get(pair[i].getNodeX()))).getIndex();
//                                                            }
...
//                              System.out.println(""cluster_array[""+i+""] is ""+i);
//                    }
...
//                    while (cluster_array[out.getNodeX()] == cluster_array[out.getNodeY()] ) {
