...
public class Clustering {
    ...
    public static void main(String[] args) throws Exception {
        try (BufferedReader br = new BufferedReader(new FileReader(args[0]))) {
            ...
            Merge.sort(wei);
            Cluster r1=wei[number*2-4];
            Cluster r2=wei[number*2-5];
            Cluster r3=wei[number*2-6];
            String y1 =String.format(""%.2f"", r1.x);
            String y2 =String.format(""%.2f"", r1.y);
            String y3 =String.format(""%.2f"", r2.x);
            String y4 =String.format(""%.2f"", r2.y);
            String y5 =String.format(""%.2f"", r3.x);
            String y6 =String.format(""%.2f"", r3.y);
            String y7 = String.format(""%.2f"",close.getDistance());
            System.out.println(r1.size + "" "" + y1 + "" "" + y2);
            System.out.println(r1.size + "" "" + y3 + "" "" + y4);
            System.out.println(r1.size + "" "" + y5 + "" "" + y6);
