 ...
 private static class setPoint implements Comparable <setPoint> { 
    ...
    public static void main(String[] args)throws Exception {
     ...
     try (BufferedReader br = new BufferedReader(new FileReader(args[0]))) {
        ...
        Point2D[] centerpoints = new Point2D[2*N];
        Point2D[] noconnectpoints = new Point2D[N];
        int [] indexcenterpoints = new int[N];
        int [] tempindexcenterpoints = new int[2*N];
        int [] unioncenterpoints = new int[2*N];
        int [] indexcenterpoints2or1 = new int[2*N];
        int [] indexpoints = new int[2*N];
        UF indexall =new UF(N);
        Clustering[] cluster = new Clustering[2*N];
...
//          System.out.println(points[i].x()+""\t""+points[i].y());
        ...
        for (int i=0;i<N;i++){
            ...
            Clustering[] findsmallcluster = new Clustering[N];
...
//                    System.out.println(findsmallpqueue.min());
//                    StdDraw.line(findsmallpqueue.min().p1.x(), findsmallpqueue.min().p1.y(),findsmallpqueue.min().p2.x(), findsmallpqueue.min().p2.y());
        ...
        int nn=0;
        int t=0;
        Clustering[] tempcluster2 = new Clustering[N];
...
//        Clustering[] tempcluster6 = new Clustering[1];
...
//            for(int i=0;i<c;i++){
//                if(indexcenterpoints[i]==0){
//                StdDraw.setPenColor(Color.BLACK);
//                StdDraw.filledCircle(centerpoints[i].x(), centerpoints[i].y(),0.01);
...
//                    if( j==c-1 && tempindexcenterpoints[i]==0 && indexcenterpoints[i]==0  && !tempointpqueue.isEmpty()){                 // j is final 
//                            tempcluster6[0]=tempointpqueue.min();
//                            for(int g=0;g<c;g++){ // find p2 has been mark
//
//                                if(tempcluster6[0].p2.equals(centerpoints[g]) && tempindexcenterpoints[j]==0 && indexcenterpoints[j]==0){
//                                       tempindexcenterpoints[g]=1;
//                                       tempindexcenterpoints[i]=1;
//                                       tempcluster6[0]=tempointpqueue.delMin();
//                                       cneterpointpqueue.insert(tempcluster6[0]);
//                                       break;
//                                }
//                            }
//                        }
