        ...
        try (BufferedReader br = new BufferedReader(new FileReader(args[0]))) {
            ...
            while (clusternum > 3) {
                ...
                if (a.a.valid == 1  && a.b.valid == 1) {
                    ...
                    wei[id] = new Cluster(a.a.centriodx(), a.a.centriody(), a.a.getSize(), a.a.getIndex(), a.a.getHead());
                    wei[id].merge(a.b);
                    queue[a.a.getIndex()] = wei[id];
                    queue[a.b.getIndex()] = queue[clusternum-1];
                    for (int i = 0; i < clusternum; i++) {
                        if (queue[i].valid == 1 && i!=a.a.getIndex()) {
