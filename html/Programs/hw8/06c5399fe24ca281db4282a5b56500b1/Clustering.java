...
public class Clustering implements Comparable<Clustering> {
    ...
    public static class Event implements Comparable<Event> {
        ...
        public Clustering a, b;       // particles involved in event, possibly null
    ...
    public static void main(String[] args) throws Exception {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(args[0]))) {
            ...
            Clustering[] finalclusters = new Clustering[N];
            int ind = 0;
            ...
            for(int i = 0; i < N; i++){
                for(int j = i+1; j < N; j++){
                    double currentmin = finalclusters[i].minDist(finalclusters[j]);
                    if(currentmin < minimum ) minimum = currentmin;
                }
            }
            if(N == 1) minimum = 0;
