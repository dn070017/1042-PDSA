...
public class Clustering {
    ...
    public static void main(String[] args) throws Exception {
        try (BufferedReader br = new BufferedReader(new FileReader(args[0]))) {
            ...
            for (int i = number*2-4; i > number*2-7; i--) {
                String s1 = String.format(""%.2f"", wei[i].centriodx());
                String s2 = String.format(""%.2f"", wei[i].centriody());
                System.out.println(wei[i].size + "" "" + s1 + "" "" + s2);
            }
