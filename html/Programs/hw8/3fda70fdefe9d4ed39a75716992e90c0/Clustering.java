        ...
        try (BufferedReader br = new BufferedReader(new FileReader(args[0]))) {
            ...
            while (clusternum > 3) {
                ...
                if (a.a.valid == 1  && a.b.valid == 1) {
                    ...
                    queue[a.a.getIndex()] = new Cluster(a.a.centriodx(), a.a.centriody(), a.a.getSize(), a.a.getIndex(), a.a.getHead());
                    queue[a.a.getIndex()].merge(a.b);
                   
                    for (int i = 0; i < number; i++) {
                        if ( i!=a.a.getIndex()) {
                            Pair test = new Pair(queue[i], queue[a.a.getIndex()], i, id);
                            pq.insert(test);
                        }
                    }
                    id++;
            ...
            System.out.println(String.format(""%.2f"", pq2.min().getDistance()));
