...
public class Clustering {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(args[0]))) {
            ...
            Point[] checkarray = new Point[pointCount*(pointCount-1)/2];
            int checknum = 0;
            ...
            checkarray[checknum++] = temp.point1;
            checkarray[checknum++] = temp.point2;
...
//                }
                ...
                while (loopend == 0) {
                    ...
                    for (int i = 0; i < checknum; i++) { 
                        if ((checkarray[i].equals(temp.point1))  || (checkarray[i].equals(temp.point2))) {
