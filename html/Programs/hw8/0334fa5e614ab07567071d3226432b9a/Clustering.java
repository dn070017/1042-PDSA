        ...
        try (BufferedReader br = new BufferedReader(new FileReader(args[0]))) {
            ...
            while (clusternum > 3) {
                ...
                if ( a.b.valid == 1) {
                    ...
                    for (int i = 0; i < number; i++) {
                        if (wei[id].getIndex() != i) {
                            Pair test = new Pair(queue[i], queue[wei[id].getIndex()], i, id);
                            pq.insert(test);
                        }
                    }
                    id++;
            ...
            for (int i = 2; i > -1; i--) {
                ...
                String s1 = String.format(""%.2f"", chap[i].centriodx());
                String s2 = String.format(""%.2f"", chap[i].centriody());
                System.out.println(chap[i].size + "" "" + s1 + "" "" + s2);
            }
