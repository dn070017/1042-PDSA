...
public class Clustering {
    ...
    class Pair implements Comparable<Pair> {
        ...
        /**
         * method: merge
         * return the new cluster fro
         * @return m the two clusters in the pair
         */
    ...
    class Cluster implements Comparable<Cluster>{
        ...
        //    @Override
        //    public int compare(Cluster v, Cluster w)
        //    { return Double.compare(v.getCentroid().x(), w.getCentroid().x()); }
        //} // end class ByX
        
        //private static class ByY implements Comparator<Cluster> {
        //    @Override
        //    public int compare(Cluster v, Cluster w)
        //    { return Double.compare(v.getCentroid().y(), w.getCentroid().y()); }
        //} // end class ByY
        
        // 1. descending order by size 2. ascending order by coordinates x, coordinates y
        @Override
    ...
    public Clustering(Point2D[] points) {
        ...
        uf = new WeightedQuickUnionUF(len); // UF of points
    ...
    public void update(Cluster newCluster) {
        ...
        for (int idx = 0; idx < len; idx++) {
            ...
            // insert pair form by newCluster
