...
//							eventlist.remove(0);
					...
					//if(place_a<N & place_b<N){
						uf.union(place_a, place_b);
					//}
					...
					newcluster.intarray = clusterarrlist.get(place_a).intarray;
...
//				System.out.println("" "");	
				...
				double small;
				//System.out.println(clusterarrlist.get(2).intarray.size());
				...
				System.out.println("""");
				for(i = 0 ; i< clusterarrlist.get(0).intarray.size();i++){
					System.out.print(clusterarrlist.get(0).intarray.get(i) + "" "");
				}
				System.out.println("""");
				for(i = 0 ; i< clusterarrlist.get(1).intarray.size();i++){
					System.out.print(clusterarrlist.get(1).intarray.get(i) + "" "");
				}
				System.out.println("""");
				for(i = 0 ; i< clusterarrlist.get(2).intarray.size();i++){
					System.out.print(clusterarrlist.get(2).intarray.get(i) + "" "");
				}
				System.out.println("""");
