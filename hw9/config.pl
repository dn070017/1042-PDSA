...
#$SpaceLimit  = '163840;        # Virtual Memory limit, in kilo-bytes
...
$CompileCmd  = '$JAVAC -cp algs4.jar:stdlib.jar Tester.java Node.java $source';
$ClassName   = 'Expression';
$TestCmd     = '-cp algs4.jar:stdlib.jar:. Tester $test_in > $user_out';
$TimeLimit   = '30';
$Timeout     = '30';
$PointUnit   = '1';
#$SoftLateDay = '7';
